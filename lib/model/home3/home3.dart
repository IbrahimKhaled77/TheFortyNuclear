...
import 'package:thefortynuclear/model/sub1/sub1.dart';
...
class Home3 extends StatelessWidget {
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child:GridView.count(
                                ...
                                children: List.generate(model!.data!.length~/2, (index) =>buildItem(model.data![index],context,index) ),
                              ),
                            ),
                          ],
                        ),
  ...
  Widget buildItem(Data model,context,index){
    return   InkWell(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Sub1(model: model,index:index)));
      },
      child: Padding(
